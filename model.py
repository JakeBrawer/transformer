...
class EncoderBlock(nn.Module):
    def __init__(self, d_model, d_embedd, dropout, n_heads):
        super().__init__()
        self.MHAttention = MultiHeadAttention(d_model, d_embedd,decoding=False, n_heads=n_heads)
...
class Decoder(nn.Module):
    def __init__(self, d_model, d_embedd, dropout, n_heads=8, d_blocks=6):
        super().__init__()
        self.blocks = nn.ModuleList([DecoderBlock(d_model, d_embedd, dropout, n_heads)] * d_blocks)
